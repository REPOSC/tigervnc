...
[Files]
#ifdef BUILD_WINVNC
Source: "D:/vnc/tigervnc/cmake-build-debug\win\winvnc\winvnc4.exe"; DestDir: "{app}"; Flags: ignoreversion restartreplace; 
Source: "D:/vnc/tigervnc/cmake-build-debug\win\wm_hooks\wm_hooks.dll"; DestDir: "{app}"; Flags: ignoreversion restartreplace; 
Source: "D:/vnc/tigervnc/cmake-build-debug\win\vncconfig\vncconfig.exe"; DestDir: "{app}"; Flags: ignoreversion restartreplace; 
#endif
Source: "D:/vnc/tigervnc/cmake-build-debug\vncviewer\vncviewer.exe"; DestDir: "{app}"; Flags: ignoreversion restartreplace; 
