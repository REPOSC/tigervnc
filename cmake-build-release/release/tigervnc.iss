...
AppVerName=TigerVNC 64-bit 1.10.80 ()
#else
AppName=TigerVNC
AppVerName=TigerVNC v1.10.80 ()
#endif
AppVersion=1.10.80
...
#endif
LicenseFile=D:/vnc/tigervnc\LICENCE.txt
...
[Files]
#ifdef BUILD_WINVNC
Source: "D:/vnc/tigervnc/cmake-build-release\win\winvnc\winvnc4.exe"; DestDir: "{app}"; Flags: ignoreversion restartreplace; 
Source: "D:/vnc/tigervnc/cmake-build-release\win\wm_hooks\wm_hooks.dll"; DestDir: "{app}"; Flags: ignoreversion restartreplace; 
Source: "D:/vnc/tigervnc/cmake-build-release\win\vncconfig\vncconfig.exe"; DestDir: "{app}"; Flags: ignoreversion restartreplace; 
#endif
Source: "D:/vnc/tigervnc/cmake-build-release\vncviewer\vncviewer.exe"; DestDir: "{app}"; Flags: ignoreversion restartreplace; 
Source: "D:/vnc/tigervnc\README.rst"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:/vnc/tigervnc\LICENCE.TXT"; DestDir: "{app}"; Flags: ignoreversion
